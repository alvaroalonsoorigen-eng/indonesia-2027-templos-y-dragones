...
### S. Aligerado de las secciones finales y apoyo visual (5 de septiembre de 2026)
* **Petición:** *"desde este apartado Logística aérea hasta el final, es todo con mucho texto y muy repetitivo, trabaja esta parte mejor. puedes crear imagenes o buscarlas e indexarlas igual en base64"*.
* **Diagnóstico previo, con medición:** la guía práctica acumulaba **2.958 palabras en 46 párrafos**, y las secciones de **logística aérea y de criterio no tenían ni una sola imagen**. Se detectaron además **ocho conceptos repetidos entre secciones** (tasa del parque, visado, tasa de Bali, calidad del colchón, protector solar reef-safe, las compañías del vuelo doméstico, el rechazo al sur masificado y el terremoto de Flores).
* **Logística aérea, rehecha.** Los párrafos se han sustituido por **una tarjeta por opción con la ruta dibujada en SVG**: una tira de nodos donde el tren va en trazo discontinuo, los vuelos en trazo continuo, la escala en color distinto y cada tramo con su dato. Se comparan de un vistazo las dos opciones recomendadas y las dos descartadas. Pasa de **402 a 308 palabras** y de **0 a 4 fotografías**. El gráfico es vectorial generado en el propio `build.py`, así que no pesa nada y no es una fotografía inventada.
* **Criterio, rehecho.** Los tres descartes (Gili, Nusa Penida y el sur de Bali) pasan de listas de texto a **tarjetas con fotografía real del sitio**, con el motivo en una línea destacada y tres puntos concretos. Las fotos van ligeramente desaturadas por CSS, porque ilustran algo que se descarta y no deben invitar.
* **Tira de fotos movida de sitio.** Las de Zaragoza Delicias, Changi y Doha estaban en la guía práctica, donde no venían a cuento; ahora encabezan la sección de vuelos, que es su contexto natural. Se detectó y corrigió que la operación las había **duplicado en ambas secciones**, lo que engordaba el fichero 300 KB.
* **Cuatro fotografías nuevas, todas de Wikimedia Commons y verificadas a ojo antes de usarlas:**
  * `avion_sq`: Airbus A350-900 de Singapore Airlines (9V-SMK) rodando en Changi. **Bahnfrend, CC BY-SA 4.0**, febrero de 2025.
  * `gili_fiesta`: noche de fiesta en un bar de Gili Trawangan. **Vyacheslav Argenberg, CC BY 4.0**. Es de 2010 y está trepidada, cosa que se asumió a conciencia: es la única que retrata sin ambigüedad lo que el texto critica.
  * `kelingking`: el acantilado de Kelingking Beach en Nusa Penida, con el sendero de bajada visible. **Chainwit., CC BY 4.0**, abril de 2025.
  * `kuta_comercial`: fachada del centro comercial Beachwalk a pie de playa en Kuta. **NoPhysicist, CC BY-SA 4.0**, enero de 2020.
* **Descartes fotográficos razonados:** se rechazaron varias fotos técnicamente mejores de la playa de Kuta y de las calles de Canggu y Seminyak porque **salían vacías**, y habría sido deshonesto ponerlas junto a un texto que habla de masificación.

### T. Actualización del aviso del terremoto y aviso de navegación nocturna (5 de septiembre de 2026)
* **El aviso del terremoto se ha reescrito con datos precisos**, sustituyendo al anterior, que se quedaba en "la reconstrucción sigue en curso, conviene verificar". Ahora recoge que el puerto reabrió la navegación esa misma tarde, que **el aeropuerto de Labuan Bajo volvió a la normalidad el 17 de agosto de 2026**, que el 21 de agosto se levantaron las últimas restricciones alrededor de Komodo y Padar, y que **el parque nacional no llegó a cerrar** (el 17 de agosto ya recibía más de 2.000 visitantes diarios). Se corrigen también las cifras de víctimas (129 muertos y más de 1.700 heridos) y la magnitud (7,8 según el USGS, 7,7 según la BMKG indonesia).
* **Lo que sigue cerrado y no afecta:** Wae Rebo, Kampung Todo y el lago Kelimutu continuaban cerrados por riesgo de desprendimientos, pero ninguno está en este itinerario. Se documenta también que el hotel Jayakarta sufrió daño estructural y que hubo daños leves en AYANA, TA'AKTANA, Meruorah, Luwansa y Sudamala.
* **Hallazgo operativo relevante, añadido a los dos días del amanecer en Padar:** desde **enero de 2026 la capitanía de Labuan Bajo prohíbe la navegación nocturna** de barcos turísticos, tras el naufragio del KM Putri Sakinah en el estrecho de Padar en diciembre de 2025. Eso hace **imposible salir de madrugada del puerto para llegar al alba**: la única vía legal es fondear la tarde anterior cerca de la isla, que es exactamente lo que hace este itinerario. Se añade además el matiz honesto de que esa cima se comparte con más de cien barcos en temporada alta.

### U. Cómo contratar el barco de Komodo, con enlaces reales (5 de septiembre de 2026)
* **Petición:** *"ponme enlaces del barco tradicional o de las excursiones como ejemplo e indica si los blogs recomiendan cogerlas mejor allí y donde o como. me gustan mucho viajeros tipo Welcome to el mundo que tienen web y cuentan todo bien"*.
* **Sobre el blog de referencia, respuesta honesta:** *Welcome to el mundo* **existe y es auténtico** (Belén Delgado y Julio Barrios, con presencia real en redes), pero **no sirve para esto y así se le dijo al cliente**: su web devolvía error 500 en todas las rutas el día de la consulta, y su única entrada de Indonesia es una guía de Bali de 2019 donde Komodo aparece en dos párrafos, sin barco, sin agencia, sin precio y sin itinerario. No se citó para no forzar una fuente que no aporta.
* **Bloque nuevo en la sección de logística**, que pasa a cubrir vuelos y barco:
  * **Aviso destacado sobre el cupo:** desde el 1 de abril de 2026 el parque tiene un tope de 1.000 visitantes al día, la entrada se reserva por la app oficial SiOra con código QR y **se ha suprimido la venta en taquilla**, con tres franjas horarias de acceso. Se explica el error caro: **el barco y la entrada son dos reservas independientes**, y tener goleta no reserva cupo.
  * **Cuatro fichas de operador con enlace comprobado**, distinguiendo expresamente **quién es armador y quién intermediario**: Catnazse (el único que ya publica tarifas de 2027, 540 USD el camarote Cafasa), Neptune Cruise (el que mejor acredita ser propietario del barco, 610 USD el Deluxe), Phinisi Labuan Bajo (la opción asequible, unos 290 €, **con el aviso de que su web no menciona aire acondicionado**) y Komodo Luxury (excursión de un día, 90 USD por persona).
  * **Seis preguntas para hacer por escrito antes de pagar la señal**, incluida la del generador en indonesio, la ubicación exacta del camarote respecto a la sala de máquinas, quién saca el cupo de SiOra y el desglose de tasas por conceptos.
  * **Cuatro blogs españoles enlazados** (RandomTrip, Todo bien mamá, Jerry Viaja y La maleta de Carla) **con la advertencia explícita de que sus viajes son de 2017 a 2020, sus precios están obsoletos y ninguno menciona el sistema de cupos**. Se presentan como útiles para el método, no para el precio.
* **Conclusión que se traslada al documento:** para abril de 2027 conviene reservar desde España. El consejo clásico de estos blogs, llegar y regatear en la calle Soekarno Hatta, se escribió cuando la entrada se pagaba en taquilla el mismo día, y ese mundo desapareció en abril de 2026. El margen documentado por negociar en destino ronda el 17 por ciento y no compensa el riesgo de quedarse sin cupo.
* **Enlace desde el itinerario, añadido después a petición del cliente:** los seis chips de barco de los días de navegación (Goleta Phinisi y Noche a bordo, en las dos rutas) **son ahora enlaces** que llevan al bloque de operadores y precios, con el mismo comportamiento que ya tenían los chips de alojamiento. Se optó por ancla interna en lugar de enlace externo, para no sacar al lector del documento. En móvil el salto **cambia de pestaña** a Logística y luego desplaza; el resplandor de llegada se aplica al panel del aviso y no a la cabecera, porque la animación es un recuadro de sombra y sobre un texto sin fondo quedaría flotando en el aire. Verificado en escritorio y a 390 px.
* **Verificación:** los ocho enlaces externos se comprobaron uno a uno devolviendo 200, todos abren en pestaña nueva con `rel="noopener"`, y la sección se probó a 390, 768, 1024 y 1440 px con cero desbordamiento. En móvil el diagrama de rutas se desplaza dentro de su propia caja sin arrastrar la página.
* **Corrección técnica detectada al montarlo:** el CSS nuevo usaba tres variables de color que no existen en la paleta del proyecto (`--c-amber`, `--c-amber-dark` y `--border-medium`). Se sustituyeron por las reales y se añadió una comprobación que recorre todas las variables usadas en el fichero y verifica que estén definidas. Resultado: ninguna huérfana.
